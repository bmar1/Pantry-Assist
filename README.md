...
<img src="./src/frontend/public/layoutImg.png" alt="MazeHunter Ability" width="100%"/>
...
### Curated meal plans
As soon as you finish today's or tomorrows meal plan, a new one is generated for you, ready to eat, instructions provided!
...
### No need to worry!  
Feel free to refer to the website and use Pantry Assist (currently frontend only, pending AWS deployment) directly from there.
